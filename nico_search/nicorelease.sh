...
ln -s /data3/movie3/nico_search/[1-9][0-9]*/*.mp4 /data/share/movie/98\ PSP用/nico/.
ln -s /data3/movie3/nico_search/{01,03,08,09}*/*.mp4 /data/share/movie/98\ PSP用/nico_imas/.
